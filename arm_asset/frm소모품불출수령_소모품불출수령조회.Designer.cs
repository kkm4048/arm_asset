namespace arm_asset
{
    partial class frm소모품불출수령_소모품불출수령조회
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frm소모품불출수령_소모품불출수령조회));
            ...
            this.btn엑셀저장.Location = new System.Drawing.Point(923, 9);
            ...
            this.Name = "frm소모품불출수령_소모품불출수령조회";
            this.Text = "소모품 불출/수령 조회";
            this.Activated += new System.EventHandler(this.frm소모품불출수령_소모품불출수령조회_Activated);
            this.Load += new System.EventHandler(this.frm소모품불출수령_소모품불출수령조회_Load);
