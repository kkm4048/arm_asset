...
namespace arm_asset
{
    public partial class frm소모품불출수령_소모품불출 : Form
    {
        bool r초기화 = true;
        string sql;
        TextBox rtb;
         public frm소모품불출수령_소모품불출()
        {
            InitializeComponent();
        }

        private void frm소모품불출수령_소모품불출_Load(object sender, EventArgs e)
        {
            string d;
        ...
        private void frm소모품불출수령_소모품불출_Activated(object sender, EventArgs e)
        {
            포커스(txt1);
        }
        ...
        private void 등록()
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                cls_com.로그(cls_com.사용자.성명, "소모품 불출", 구분, sql);
        ...
        private void 수정()
        {
            ...
            cls_com.로그(cls_com.사용자.성명, "소모품 불출", "수정", sql);
            조회();
        ...
        private void 삭제()
        {
            ...
            cls_com.로그(cls_com.사용자.성명, "소모품 불출", "삭제", sql);
            조회();
        }
