...
namespace arm_asset
{
    public partial class frm소모품입고_소모품입고조회 : Form
    {
        
        string sql;
        public frm소모품입고_소모품입고조회()
        {
            InitializeComponent();
        }

        private void frm소모품입고_소모품입고조회_Load(object sender, EventArgs e)
        {
            초기화();
            조회0();
            조회();
        ...
        private void 조회0()
        {
            ...
            sql = "";
            sql = sql + " select a.dt ,a.state,a.num1,a.arm_code,b.arm ,count(*) cnt  \n";
        ...
        private void btn출력_거래증_Click(object sender, EventArgs e)
        {
            ...
            frm출력_거래증 frm_출력_거래증 = new frm출력_거래증("소모품_입고",cls_com.GetDate(dtp.Value),txt상태.Text,txt증빙번호.Text,txt부대1.Text,txt부대2.Text);
            frm_출력_거래증.ShowDialog();
        ...
        private void frm소모품입고_소모품입고조회_Activated(object sender, EventArgs e)
        {
        ...
        private void btn엑셀저장_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog.FileName = "소모품입고_" + cls_com.GetDate();
